...
```text
โจทย์ให้หาสีที่ผสมจากสามแม่สี
input:
ใส่สีจากสามแม่สี มีสีแดง สีเหลืองสีน้ำเงิน เป็นจำนวนสองสี
output:
ได้สีที่ผสมกันจากสองสีที่ input ไว้ ถ้าไม่ใช่สีที่ถูกกำหนดไว้ก็จะขึ้น Error และ ถ้าทั้งสองสีเป็นสีเดียวกันก็จะออกมาเป็นสีเดิม
```
...
```text
1.เขียนโค้ดรับ input
2.ใส่เงื่อนไขให้  if elif else
3.ถ้าบวกกันได้จะให้ปริ้น output ออกมาตามที่กำหนด ถ้าไม่ได้ให้ขึ้น Error
```
...
```text
คือเติม or เข้าไปทำให้เมื่อสลับที่แม่สี ผลลัพธ์ก็จะยังออกมาได้เหมือนเดิม และตรวจสอบเงื่อนไขว่าทำได้ถูกต้องหรือไม่
```
...
```text
เพราะ มันเข้าใจง่าย และ ผลก็ออกมาตามที่ต้องการ
```
